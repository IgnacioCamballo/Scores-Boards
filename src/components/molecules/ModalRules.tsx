...
export default function ModalRules({setModal}: ModalRulesProps) {
  const {lenguage} = useFarkle()

  return (
    <View style={styles.generalContainer}>
      <Button press={() => setModal(false)} color={theme.color.grey} style={styles.button}>
        <Icon
          name="doubleleft"
      ...
      <Text style={styles.title}>{translations.title.find(i => i.lenguage === lenguage)?.text}</Text>
