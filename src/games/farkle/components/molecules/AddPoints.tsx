...
import TextShownArea from '@/games/farkle/components/atoms/TextShownArea'
import Button from '@/components/atoms/Button'
import ButtonsSum from '@/games/farkle/components/molecules/ButtonsSum'
...
export default function AddPoints({playerKey}: AddPointsProps) {
  const {players, setPlayers, whosOpen, setWhosOpen} = useFarkle()
